...
.DESCRIPTION
  ING managed devices ship Java 1.8 on PATH and users cannot reorder PATH without admin
  rights. INGenious' own `ingenious.bat` invokes bare `java` / `javaw`, so it picks up 1.8
  and dies with
