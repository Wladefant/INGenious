...
public final class RecordingTargetPlugins {
     ...
     *
     * <p>Package-private rather than private so the skip-and-fallback rule can be exercised
     * without an installed plugin directory, in the same way {@code PluginLoader} exposes its
     * search-path overload to its own test.
     *
